...
public class MergeSort {
    ...
    makeSingleItemQueues(Queue<Item> items) {
        // Your code here!
        Queue<Queue<Item>> x = new Queue<Queue<Item>>();
        int z = items.size() ;
        for(int i = 0;i < z;i+=1){
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        Queue<Item> x = new Queue<>();
        while(a.size() > 1){
            Queue<Item> a1 = a.dequeue();
            Queue<Item> a2 = a.dequeue();
            a.enqueue(mergeSortedQueues(a1,a2));
